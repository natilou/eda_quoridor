...
class TestPawnsPositions:
    ...
    def test_get_opponent_pawns(self, board, side, expected):
        pawn_board = VisualBoard(board)
        opponent_pawns_positions = pawn_board.get_opponent_pawns(side)
        assert opponent_pawns_positions == expected
