...
# from bot.bot import PawnBoard, MovePawn
...
#     def test_select_pawn(self, board, side, expected):
#         pawn_board = PawnBoard(board)
#         pawns = pawn_board.get_my_pawns(side)
#         selected_pawn = random.choice(pawns)
